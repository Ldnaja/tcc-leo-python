...
def main() -> None:
    rl_config_path = Path("configs/rl/ppo_both_v4.yaml") #Alterar se caso for testar outras versões
    ...
    out_dir = Path("results/rl/evaluations/ppo_both_v4") #Alterar se caso for testar outras versões
