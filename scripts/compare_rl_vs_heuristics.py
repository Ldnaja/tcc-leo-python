...
def main() -> None:
    ...
    rl_path = Path("results/rl/evaluations/ppo_both_v4/rl_eval_summary.csv")  # Alterar se caso for testar outras versões
    out_dir = Path("results/rl/comparisons/ppo_both_v4")  # Alterar se caso for testar outras versões
